   ...
   if(searchpartnerInput) {
      searchpartnerInput.addEventListener("input", partnersOpen);
      searchpartnerInput.addEventListener("click", partnersOpen);
      searchpartnerInput.addEventListener("focus", partnersOpen);
   }
   ...
   function choseDriver(name, dphone, dplate,d_id)
   {
      searchdriverInput.value = name;
